...
import erp2 from "../../../public/images/erp2.png";
import erp3 from "../../../public/images/erp3.png";
import erp4 from "../../../public/images/erp4.png";
  ...
  const data = [
    ...
    // edu chain
    {
      ...
      content: (
        <div dir="rtl">
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Edu Chain هي منصة تعليمية ل تطوير مهارات الموظفين في المؤسسات
            والشركات الكبيرة. تم تصميمها لتكون سهلة الاستخدام ومرنة لتلبية
            احتياجات الشركات المختلفة. يمكن للموظفين الوصول إلى المواد التعليمية
            والدورات التدريبية عبر الإنترنت والتعلم على مدار الساعة.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src={educhain}
    ...
    // outseller
    {
      ...
      content: (
        <div dir="rtl">
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            OutSeller هي منصة مبيعات تساعد الشركات قي توظيف الموظفين وايضا في
            ادارة حسابات الشركات
          </p>
    ...
    // our kids
    {
      ...
      content: (
        <div dir="rtl">
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            موقع اولادنا التجاري هو موقع ل بيع العاب الاطفال وبه الكثير من
            المميزات انصحكم بزيارته
          </p>
    ...
    },
    {
      ...
      content: (
        <div dir="rtl">
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
        erp stystem هو نظام ادارة الموارد البشرية والمالية والمخازن والمبيعات
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
